...
class TestUdacidata < MiniTest::Test
  ...
  # Commented because it seems some tests are not independent
  # Receive the following multiple errors if uncomment:
  # Errno::EACCES: Permission denied @ unlink_internal - ./tests/../data/data.csv
  # It seems that sometimes DB is not created after deletion.
  #def teardown
